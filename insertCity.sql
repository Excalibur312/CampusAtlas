...
INSERT INTO city (id, name,region) VALUES(4, 'Ağrı','Doğu Anadolu');
...
INSERT INTO city (id, name,region) VALUES(9, 'Aydın','Ege');

INSERT INTO city (id, name,region) VALUES(10, 'Balıkesir','Marmara');

INSERT INTO city (id, name,region) VALUES(11, 'Bilecik','Marmara');

INSERT INTO city (id, name,region) VALUES(12, 'Bingöl','Doğu Anadolu');
...
INSERT INTO city (id, name,region) VALUES(17, 'Çanakkale','Marmara');

INSERT INTO city (id, name,region) VALUES(18, 'Çankırı','İç Anadolu');

INSERT INTO city (id, name,region) VALUES(19, 'Çorum','Karadeniz');

INSERT INTO city (id, name,region) VALUES(20, 'Denizli','Ege');

INSERT INTO city (id, name,region) VALUES(21, 'Diyarbakır','Güneydoğu Anadolu');

INSERT INTO city (id, name,region) VALUES(22, 'Edirne','Marmara');

INSERT INTO city (id, name,region) VALUES(23, 'Elazığ','Doğu Anadolu');
...
INSERT INTO city (id, name,region) VALUES(26, 'Eskişehir','İç Anadolu');
...
INSERT INTO city (id, name,region) VALUES(29, 'Gümüşhane','Karadeniz');
...
INSERT INTO city (id, name,region) VALUES(34, 'İstanbul','Marmara');

INSERT INTO city (id, name,region) VALUES(35, 'İzmir','Ege');
...
INSERT INTO city (id, name,region) VALUES(39, 'Kırklareli','Marmara');

INSERT INTO city (id, name,region) VALUES(40, 'Kırşehir','İç Anadolu');

INSERT INTO city (id, name,region) VALUES(41, 'Kocaeli','Marmara');

INSERT INTO city (id, name,region) VALUES(42, 'Konya','İç Anadolu');

INSERT INTO city (id, name,region) VALUES(43, 'Kütahya','Ege');

INSERT INTO city (id, name,region) VALUES(44, 'Malatya','Doğu Anadolu');

INSERT INTO city (id, name,region) VALUES(45, 'Manisa','Ege');

INSERT INTO city (id, name,region) VALUES(46, 'Kahramanmaraş','Akdeniz');

INSERT INTO city (id, name,region) VALUES(47, 'Mardin','Güneydoğu Anadolu');

INSERT INTO city (id, name,region) VALUES(48, 'Muğla','Ege');

INSERT INTO city (id, name,region) VALUES(49, 'Muş','Doğu Anadolu');

INSERT INTO city (id, name,region) VALUES(50, 'Nevşehir','İç Anadolu');

INSERT INTO city (id, name,region) VALUES(51, 'Niğde','İç Anadolu');
...
INSERT INTO city (id, name,region) VALUES(59, 'Tekirdağ','Marmara');
...
INSERT INTO city (id, name,region) VALUES(63, 'Şanlıurfa','Güneydoğu Anadolu ');

INSERT INTO city (id, name,region) VALUES(64, 'Uşak','Ege');
...
INSERT INTO city (id, name,region) VALUES(71, 'Kırıkkale','İç Anadolu');

INSERT INTO city (id, name,region) VALUES(72, 'Batman','Güneydoğu Anadolu');

INSERT INTO city (id, name,region) VALUES(73, 'Şırnak','Güneydoğu Anadolu');

INSERT INTO city (id, name,region) VALUES(74, 'Bartın','Karadeniz');

INSERT INTO city (id, name,region) VALUES(75, 'Ardahan','Doğu Anadolu');

INSERT INTO city (id, name,region) VALUES(76, 'Iğdır','Doğu Anadolu');

INSERT INTO city (id, name,region) VALUES(77, 'Yalova','Marmara');

INSERT INTO city (id, name,region) VALUES(78, 'Karabük','Karadeniz');
